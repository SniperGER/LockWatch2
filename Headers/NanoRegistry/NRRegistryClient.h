...
- (void)_queryDaemonWithStartingTokenValue:(NSUInteger)arg1 currentTokenValue:(NSUInteger)arg2 withBlock:(id /* block */)arg3;
- (void)_wipeRegistryWith:(NSUInteger)arg1 block:(id /* block */)arg2;
